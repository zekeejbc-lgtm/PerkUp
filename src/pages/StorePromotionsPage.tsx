...
export default function StorePromotionsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white transition-colors dark:bg-[#1b1b1b]">
      <Seo
        title={`${store.name} Promotions | PerkUp`}
        description={`See current promotions and loyalty rewards from ${store.name} on PerkUp.`}
        canonicalPath={`/store/${store.id}/promotions`}
